...
public class MockMonitor implements DataSource {
    ...
    public SystemSnapshot getLatestSnapshot() {
        ...
        List<ProcessInfo> processes = List.of(
            new ProcessInfo(1, "root", 20, 0, 500_000_000L, 50_000_000L, 10_000_000L, 'S', 0.0, 0.3, 1200_000L,
                "systemd"),
            new ProcessInfo(1234, "sebas", 20, 0, 2_000_000_000L, 800_000_000L, 50_000_000L, 'S', 45.2, 5.0, 3600_000L,
                "idea64"),
            new ProcessInfo(5678, "sebas", 20, 0, 1_500_000_000L, 600_000_000L, 40_000_000L, 'S', 23.1, 3.7, 2400_000L,
                "chrome"),
            new ProcessInfo(9012, "sebas", 20, 0, 800_000_000L, 200_000_000L, 20_000_000L, 'R', 10.5, 1.2, 900_000L,
                "java"),
            new ProcessInfo(3456, "root", 20, 0, 100_000_000L, 10_000_000L, 5_000_000L, 'S', 0.1, 0.1, 300_000L,
                "sshd"));
